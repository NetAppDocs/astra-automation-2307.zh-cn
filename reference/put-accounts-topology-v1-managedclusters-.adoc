...
* 更改 defaultStorageClass 时，将更新 Kubernetes 默认存储类。
...
JSON 字符串包含一个值，该值指示托管集群能够成为应用程序数据管理操作的 _target_。定义的值为：
...
| protectionStateDetails | 数组[link:#type_astra_stateDetail["type_astra_stateDetail"]] | False  a| 
